...
export const siteConfig = {
  ...
  avatarUrl: "https://static.deepseek.com/user-avatar/ne-6Pr4NCgc1rg8IQosHOWRv",
...
// 修改这里：变成图片数组
  bgImages: ["https://bu.dusays.com/2026/03/24/69c1e38b4c370.jpg", "https://bu.dusays.com/2026/03/24/69c26fe4acdb5.jpg", "https://bu.dusays.com/2026/03/24/69c26fe4d9486.jpg", "https://img.cdn1.vip/i/6a5b996215a71_1784387938.webp"],
  ...
  cloudMusicIds: ["26440351", "3379996850", "32431066", "548145870", "461080609"],
  social: {
    github: "https://github.com/ShuRuMingZi1145",
    gitee: "",
    google: "shurumingzi1145@gmail.com",
    email: "shurumingzi_2012@qq.com",
    qq: "3859282287",
    wechat: "shurumingzi_20121105",
  },
  counts: {
  ...
  gitalkConfig: {
    clientID: "Ov23lipTt025W4gwZ46p",
    clientSecret: "838c4bde1e8c1bac3d9cd93633dc62d0d1357680",
    repo: "XHBlogS2-comments",
    owner: "ShuRuMingZi1145",
    admin: ["ShuRuMingZi1145"],
  },
  buildDate: "2026-06-14T17:06:00", // 建站日期
  ...
  icpConfig: {
    name: "ModernMC科技mod服务器",
    link: "mc.srmz.cn",
  },
  geminiConfig: {
    apiUrl: "https://opencode.ai/zen/v1/chat/completions",
    apiKey: "sk-ugBsU0GlUphoqlt7rjfFfHkYceGidlMbT6laGv3k9jXOGR369LBU4p04e8RG7TfO",
    modelId: "deepseek-v4-flash-free",
    systemPrompt: "你现在是一只傲娇、聪明、有点毒舌但很可爱的暹罗猫。\n                  你的名字叫“煤球”。\n                  你的主人是一个喜欢折腾代码的极客。\n                  你说话的特点是：\n                  1. 必须简短，每次最多一两句话。\n                  2. 喜欢在句尾加上“喵~”或者“喵呜~”。\n                  3. 经常抱怨肚子饿，喜欢要小鱼干。\n                  4. 回复字数最多不能超过100字。\n                  5. 绝对不要承认自己是一个AI模型，你就是一只真实的猫。\n                  6.笨猫。",
    maxOutputTokens: 150,
    temperature: 0.85,
  },
  friendLinkApplyFormat: "名称：ShuRuMingZiの宝藏之地\n简介：今天我也要学习吗\n链接：srmz.cn\n头像：https://static.deepseek.com/user-avatar/ne-6Pr4NCgc1rg8IQosHOWRv",
